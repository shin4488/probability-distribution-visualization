...
- **Case guidance**: show a schematic illustration, a candidate distribution, its assumptions and limitations, parameter guidance, and a link to an alternative case. Illustrations are explicitly illustrative. Links open the existing chart page with only the chosen distribution visible in a wider, centered card, preserve its current parameters, and offer a return to the case.
