...
- **9 probability distributions**, ordered the way statistics is learned (prerequisite distributions first, closely related ones adjacent): Bernoulli, binomial, negative binomial, Poisson, exponential, gamma, beta, normal, and log-normal
